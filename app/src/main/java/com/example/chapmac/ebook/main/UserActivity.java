...
public class UserActivity extends AppCompatActivity implements UserView {
    ...
    public void onMain(View view) {
        ...
        intent.putExtra("collectionListSize", collection.size()+"");
        intent.putExtra("money", presenter.getMoney()+"");
    ...
    public void updateMoney(double amount) {
        money.setText("Money: "+ amount + " USD");
    }

    @Override
    public void setBookResult(ArrayList<String> books) {
